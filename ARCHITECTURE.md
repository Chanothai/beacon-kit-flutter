...
- **ผู้ใช้/ระบบปรับนาฬิกาเครื่อง (manual หรือ NTP sync) มีผลต่อคูลดาวน์นี้โดยตรง**
  ...
  **ขอบเขตของ fail-closed ที่เหลืออยู่นี้ (ก2) มีเพดานเท่ากับขนาดของการปรับนาฬิกา
  ครั้งนั้นเท่านั้น** (หลักวินาทีถึงสิบนาที เกิดเฉพาะตอนมีการปรับนาฬิกาจริง)
  **ต่างจากบั๊ก `systemUptime` ที่กำลังแก้อยู่ ซึ่งยืดเป็นสัดส่วนกับเวลาที่เครื่องหลับ
  ทุกครั้งที่เครื่องหลับ ไม่มีเพดาน** (~2.7-2.8 เท่าตามตัวเลขในบรีฟ, §4.3) — นี่คือ
  เหตุผลที่ยังเลือก (ก) อยู่ ไม่ใช่เหตุผลให้กลับไปเลือก (ข)
- **guard `last > now` แก้ได้เฉพาะเคส "นาฬิกาถอยหลังมากกว่าเวลาที่ผ่านไปตั้งแต่
  ...
  ขนาดผลกระทบของ (1)/(2) มีเพดานเท่ากับขนาดของการปรับนาฬิกาครั้งนั้น (หลักนาที
  ถึงสิบนาที ไม่ใช่กลืนแจ้งเตือนเป็นชั่วโมงแบบบั๊กที่กำลังแก้ใน §4.3)

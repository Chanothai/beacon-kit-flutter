...
> **สถานะ: ตัดสินใจแล้ว — code-complete, unverified (POC 10 ก.ย. 2026)**
...
>
> **ยังไม่เคยรันกับ K9P จริงแม้แต่ครั้งเดียว** — ห้ามอ่านว่า "ทำงานได้" จนกว่าจะมี
> ไฟล์หลักฐานจากรอบเดินจริง · เกณฑ์ที่ต้องเห็น: บรรทัด `proximity` ที่ `mode=bg`
> ไปถึง `bucket=near` **และ** บรรทัด `event=notification` ตามมาในโปรเซสที่

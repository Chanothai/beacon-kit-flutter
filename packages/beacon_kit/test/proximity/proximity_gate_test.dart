...
void main() {
  ...
  group('J: บั๊ก 4 ข้อที่แก้ใน ea7e12c', () {
    ...
    test(
      '[2/4] stale reset ล้าง pending dwell — ดูกลุ่ม K.a ด้านล่าง (เทสต์เดียวกัน '
      'ล็อกทั้งบั๊ก 2/4 นี้และหัวข้อ K.a ของ ADR-19 หัวข้อ 6(ฉ) พร้อมกัน ไม่แยกซ้ำ)',
      () {},
      skip:
          'ดูเทสต์ "[K.a] stale ขณะ pending dwell (ยังไม่ confirmed)" ในกลุ่ม K — '
          'เป็นเทสต์เดียวกัน ไม่ต้องเขียนซ้ำ',
    );

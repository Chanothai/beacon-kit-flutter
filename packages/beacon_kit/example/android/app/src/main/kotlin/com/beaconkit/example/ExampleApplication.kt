...
class ExampleApplication : Application() {
    ...
    override fun onCreate() {
        ...
        // โดยสิ้นเชิง ไม่แตะตรรกะเดิมแม้แต่บรรทัดเดียว** เพราะชั้น 1 มีหลักฐานจาก
        // อุปกรณ์จริงระดับ `observed` แล้ว (ADR-14) ส่วนชั้นนี้ยังไม่เคยรันกับ K9P
        // จริงแม้แต่ครั้งเดียว
        //

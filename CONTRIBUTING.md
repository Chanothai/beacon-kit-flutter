...
⚠️ **ข้อยกเว้นที่ยังค้าง (ต้องแปลงเมื่อแตะ ADR นั้นครั้งถัดไป):** **ADR-17** และ
**ADR-19** ยังเขียน `code-complete, unverified` ในแบนเนอร์ — **PR 11 ก.ย. แปลงเฉพาะ
ADR-20/21/22** คำสั่ง `grep` ข้างบนจึงยัง**คืน 2 บรรทัด**อยู่ ณ วันที่เพิ่มกฎนี้
**ห้ามอ่านว่ากติกานี้ไม่มีผล** — และห้ามเพิ่มบรรทัดที่ 3
(ADR-16 ใช้รูปแบบที่ถูกต้องอยู่แล้ว: `implemented — merged PR #18` + บรรทัดชี้ไป
ไฟล์เช็คลิสต์)

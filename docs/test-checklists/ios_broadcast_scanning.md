...
### สิ่งที่วัดได้จากไฟล์ (นับเอง ไม่ใช่ความรู้สึก)

| | รอบ counters (1000 ms · build `4c6f648`) | รอบ POC (300 ms · build `ead3b02`) |
|---|---|---|
| `unknown` / `inArray` ตอน background | **65%** (24/37) | **20%** (4/20) |
| `didRange` เฉลี่ยตลอดช่วง background | ทุก **16.2 วินาที** | ทุก **9.6 วินาที** (20 ครั้งใน 191.6 วินาที) |
| `didRange` **ช่วงพุ่งทันทีหลัง `didEnterRegion`** | ไม่มีข้อมูล (ไม่เคยมี `enter` ในช่วงนั้น) | **~1 Hz** — `rangeCb` 1→3 ใน 2.0 วินาที (17:24:13-15) และ 21→25 ใน 4.0 วินาที (17:27:25-29) |

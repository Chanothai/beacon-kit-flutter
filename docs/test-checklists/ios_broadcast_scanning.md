...
|---|---|---|---|---|---|
| 1. Permission prompt | **ไม่ผ่าน (รอบ 1 + รอบ 2)** → แก้แล้วทั้งคู่ **รอทดสอบซ้ำ** | 27 ส.ค. 2026 | _(ผู้ทดสอบกรอก)_ | _(ผู้ทดสอบกรอก)_ | รอบ 1: sync authorization check / รอบ 2: state ค้างใน broadcast controller ฝั่ง Dart — ดูหัวข้อ 1 🐞 ทั้งสองอันด้านบน แก้แล้วแต่ยังไม่ verified |
...
**อัปเดต 27 ส.ค. 2026:** ทดสอบบนเครื่องจริงไปแล้ว 2 รอบ **เฉพาะข้อ 1** ทั้งสองรอบ
**ไม่ผ่าน** และทำให้เจอบั๊กคนละตัวกันสองตัว (ดูหัวข้อ 1 🐞 รอบ 1 และ 🐞 รอบ 2)
แก้แล้วทั้งคู่แต่**ยังไม่ได้ทดสอบซ้ำ** ข้อ 2-7 ยังไม่เคยทดสอบเลยแม้แต่ครั้งเดียว
ช่องรุ่นเครื่อง/iOS/K9P ยังว่างอยู่ รอผู้ทดสอบกรอก

**บทเรียนจากสองรอบนี้:** ทั้งสองบั๊กคอมไพล์ผ่านและเทสต์เดิมเขียวหมด แต่พังบนเครื่อง
จริงทันทีที่มีคนกดปุ่มจริง — เป็นหลักฐานตรงตัวว่าทำไม `SPRINT.md` ถึงห้ามนับ
